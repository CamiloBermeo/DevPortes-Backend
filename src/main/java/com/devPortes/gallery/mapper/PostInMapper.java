...
public class PostInMapper {
    ...
    public static Post toEditModel(EditPostRequestDto dto, List<String> urlPictures){
        return Post.edit(
                dto.name(),
                dto.description(),
                urlPictures(),
    ...
    public static List<PostsCompleteResponseDto> toPostsCompleteResponseDtoList(List<Post>models){
        return models.stream().map(PostInMapper::toPostsCompleteResponseDto)
                .toList();
    }
}
